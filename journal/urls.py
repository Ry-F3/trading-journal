...
# from . import views
# from django.urls import path
# from .views import trade_list, delete_trade, get_trade_details, generate_report, ContactView, BlogView, TradeFilterView, update_portfolio_balance, get_portfolio_balance
